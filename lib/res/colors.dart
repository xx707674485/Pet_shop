...
class Colours {
  static const Color app_main = Color(0xFFFCA50A);  //主色调
  static const Color app_main_light = Color(0xFFFFBB05); //亮主色（辅助色）
  static const Color dark_app_main = Color(0xFF3F7AE0);
  static const Color app_title=Color(0xFF333333);   //标题
  static const Color app_content_title=Color(0xFF777777);   //正标题
  static const Color app_content_content=Color(0xFFAAAAAA);   //次要信息
  static const Color bg_color = Color(0xFFF4F4F4);   //分割线  背景色
