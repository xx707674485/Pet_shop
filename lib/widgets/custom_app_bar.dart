...
import 'package:flutter_shop/config/constant_config.dart';
...
class CustomAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  CustomAppBar({
    ...
    Function(String value) onSearch
       ...
       _onSearch = onSearch != null ? onSearch : null,
       super();
...
class _CustomAppBarState extends State<CustomAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion(
      value: widget.style ?? SystemUiOverlayStyle.light,
      child: Container(
                ...
                Positioned(
                  ...
                  child: _isSearching 
                      ? GestureDetector(
                          ...
                          child: Row(children: <Widget>[Text("取消"), SizedBox(width: LayoutConstant.default_margin)]),
                        )
                      : Container(
